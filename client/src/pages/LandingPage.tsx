...
export default function LandingPage() {
  ...
  const stats = [
    { value: "5.0/5", label: "Note Google (36 avis)" },
    { value: "24/7", label: "Disponibilité" },
    { value: "500+", label: "Clients satisfaits" },
    { value: "100%", label: "Service premium" },
  ];

  const testimonials = [
    { name: "Alec", role: "Client vérifié Google", text: "Highly recommend Majestic South Chauffeurs. We had a tight pick up requirement and they accommodated us fully and provided more than 5 star service and a seamless experience." },
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-amber-700/50 bg-amber-900/20 text-amber-400 text-sm mb-8">
            ...
            <span>Service VTC Premium — Marseille &amp; Région PACA</span>
          </div>
            ...
            {vehicles.map((v) => (
              <div key={v.name} className="rounded-2xl border border-amber-900/30 bg-gradient-to-b from-[#1a1400] to-[#0d0b07] overflow-hidden hover:border-amber-600/50 transition-all">
                <div className="h-40 flex items-center justify-center bg-gradient-to-b from-[#1a1400] to-[#0d0b07]">
                  <v.Icon className="h-16 w-16" style={{ color: '#d4af37', opacity: 0.7 }} />
                </div>
                <div className="p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-8 leading-relaxed">
                Majestic South Chauffeurs est une SAS de transport VTC premium basée à Marseille (13010),
                spécialisée dans les transferts et mises à disposition avec chauffeur privé dans toute la région PACA.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center p-6 rounded-2xl border border-amber-900/30">
              ...
              <div className="text-gray-400 text-sm">Bât D, 131 Bd de Saint-Loup<br />13010 Marseille</div>
            </div>
          </div>
        </div>
      </section>
