    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: DARK }}>
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-400 mb-2">Votre demande de réservation a bien été reçue.</p>
        ...
        {step === 3 && (
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={handleSubmit} disabled={createDemand.isPending}
                ...
                {createDemand.isPending ? "Envoi..." : "Confirmer la réservation"} <CheckCircle className="h-4 w-4" />
              </button>
            </div>
          </div>
        )}
