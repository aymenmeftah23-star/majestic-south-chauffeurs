...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Fallback : creer via tRPC clients.create
      try {
      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 relative">
        ...
        <div className="relative z-10 w-full max-w-md text-center">
          <div className="bg-[#111] border border-amber-900/30 rounded-3xl p-8">
            ...
            <h2 className="text-2xl font-bold text-white mb-3">Compte cree avec succes</h2>
            <p className="text-gray-400 mb-6">
              Bienvenue chez Majestic South Chauffeurs. Vous pouvez maintenant vous connecter a votre espace client.
            </p>
            <button
        ...
        <div className="bg-[#111] border border-amber-900/30 rounded-3xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-300 mb-2">Prenom *</label>
                <input
                  type="text"
                  name="firstName"
            ...
            <div>
              <label className="block text-sm text-gray-300 mb-2">Societe (optionnel)</label>
              <input
                type="text"
                name="company"
                value={form.company}
